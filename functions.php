...
function async_cat_menu(){
    $categories = get_categories(); ?>

    <ul id="category-menu" class='nav'>
        <?php foreach ( $categories as $cat ) { ?>
        <li id="cat-<?php echo $cat->term_id; ?>"><a class="<?php echo $cat->slug; ?> asnyc"  cat="<?php echo $cat->term_id; ?>" href="<?php echo get_category_link($cat->cat_ID);?>"><?php echo $cat->name; ?></a></li>
        <?php } ?>
    </ul>  
    <?php  
}
...
function html5blank_header_scripts()
{
    if (!is_admin()) {
        ...
        wp_register_script('history', get_template_directory_uri() . '/js/jquery.history.js', array(), '1.0.0'); // History scripts
        wp_enqueue_script('history'); // Enqueue it!
